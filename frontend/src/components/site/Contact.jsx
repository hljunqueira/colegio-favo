          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4" data-testid="contact-address">
              ...
              <div>
                ...
                <p className="font-body text-cream/90 text-lg">{SCHOOL.address}</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href={`tel:${SCHOOL.phoneRaw}`} className="font-body text-cream/90 text-lg hover:text-honey transition-colors">
                  {SCHOOL.phone}
                </a>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="font-display font-extrabold text-cream text-2xl">{SCHOOL.rating} <span className="font-body font-normal text-base text-cream/60">/ {SCHOOL.reviews} avaliações</span></p>
              </div>
            </div>
            <a
