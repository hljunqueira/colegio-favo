...
export declare class GestaoController {
    private readonly gestaoService;
    constructor(gestaoService: GestaoService);
    getStats(): Promise<{
    ...
    createProfessor(body: any): Promise<{
        email: string;
        phone: string;
        matricula: string;
        password: string;
